        ...
        <div class="col-6 offset-3 card">
            <div class="row py-3">
                <h5>Data Diri</h5>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" class="form-control" id="inputNama1" name="nama_ktp">
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="inputKTP1" class="form-label">No. KTP</label>
                        <input type="tel" class="form-control" id="inputKTP1" name="no_ktp">
                    </div>
                    <div class="col-md-6 mb-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="tel" class="form-control" id="inputJobPlace" name="job_detail">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="social_media_link" id="inputSocialMedia">
                    </div>
            ...
            <div class="row py-3">
                ...
                <div class="col-md-8 mb-2">
                    ...
                    <input type="text" class="form-control" id="inputNamaProyek" name="proyek_name">
                </div>
                <div class="col-md-4 mb-2">
                    ...
                    <select class="form-select mt-2" id="proyek_type" name="proyek_type">
                        ...
                        <option value="{{ $proyek_type->name}}">{{ $proyek_type->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6 mb-2">
                    <label for="inputPassword4" class="form-label">Lokasi</label>
                    <input type="text" class="form-control" name="location" id="inputPassword4">
                </div>
                <div class="mb-3 col-md-12 mb-2">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="tujuan_penggalang" rows="3"
                        placeholder="Kami merupakan lembaga amil zakat yang bergerak dalam penghimpunan dana Zakat, infaq, sedekah, kemanusiaan, dan CSR perusahaan"></textarea>
                </div>
