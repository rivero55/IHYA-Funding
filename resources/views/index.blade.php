...
<main class="l-main">
        ...
        @endforeach
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Mudah</h3>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <h2 class="section-title">Tim LindungiPeduli innovilage</h2>

                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="{{asset('assets/img/henry.jpg')}}" alt="" class="menu__img">
                    ...
                    <div class="menu__content">
                        <img src="{{asset('assets/img/meli.png')}}" alt="" class="menu__img" style="padding-bottom:15px;">
                    ...
                    <div class="menu__content">
                        <img src="{{asset('assets/img/vero.jpg')}}" alt="" class="menu__img">
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <h2 class="section-title contact__initial">Hubungin Kami</h2>
